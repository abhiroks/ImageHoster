...
public class ImageController {
    ...
    public String showImage(@PathVariable("imageId") Integer imageId, Model model) {
        ...
        List<Comment> comments = imageService.getAllComment(imageId);
    ...
    public String createComment(@RequestParam("comment") String newComments , @PathVariable("imageId") Integer imageId , Model model, HttpSession session ) {
        Image image = imageService.getImageByTitle(imageId);
